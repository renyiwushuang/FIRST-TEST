...
if __name__ == "__main__":
    ...
    # MXD2670.HCI_dcdc_config(self=MXD2670, H2Val=1)
    time.sleep(1)
    while 1:
        # MXD2670.HCI_port_init(self=MXD2670, port=HCIPort, bps=115200, timeout=2)
        MXD2670.HCI_rf_tx_test(self=MXD2670, channel=25, payloadtype=HCI_For_Serial.PayloadTypeDef.ALL1,
                               test_mode=HCI_For_Serial.RfTestModeDef.LE1M)
        time.sleep(1)
        MXD2670.HCI_rf_tx_end(self=MXD2670)
    ...
    # MXD2670.HCI_ldo_act_voltage(self=MXD2670, ldoAct=HCI_For_Serial.LdoActDef.LDO_ACT_1200mV)
    # # # MXD2670.HCI_tx_pa_acw_config(self=MXD2670, AcwVal=255, TxGainSel=TxPowerDef.TX_0_DBM)
    # MXD2670.HCI_reg_acg_mode(self=MXD2670, AcgMode=HCI_For_Serial.RegAcgModeDef.GAIN0)
